...
<div class="social-links">				<ul>
	...
	<div id="main">
	  ...
	  <div id="sidebar" class="left">
		...
		<!-- End Sidebar -->
<script>
function deleteAlert(id,memberid){
var conBox = confirm("Are you sure you want to delete?");
if(conBox){
location.href="<?=$_SERVER['PHP_SELF'];?>?action=delete&listid="+id+"&userid="+memberid+"&mode=remove";
...
{
$message = insertintodatabase($_GET);
...
{
//echo "r u sure?";
$message = deletefromdatabase($_GET);
...
{
//echo "r u sure to update??";
}

if ($_GET["action"] == "view")
{
$message = "Browse Current Lists!";
}
		  ...
		  <div class="entry">
			 ...
			 <div class="gallery-holder">
			   ...
			   <table width="617" border="0">
				  ...
				  <tr>
                    <td class="dd" ><span class="style4">PICTURE</span></td>
                    <td class="dd"><span class="style4">ListID</span></td>
                    <td  class="dd"><span class="style4">Added date </span></td>
		           <td colspan="2" class="dd"  ><span class="style4">ACTION</span></td>
                  </tr>
				  
				  <?php createlistid($_GET);?>
				  </table>
